...
export default function Hero() {
    ...
    return (
        <section className="flex md:flex-row flex-col md:justify-evenly">
            ...
            <DemoCard />
            {!context.currentAccount ? <p className="text-sl text-center md:text-left font-light">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex, corrupti repellat? Inventore id dolorem adipisci. Veritatis ipsam quos provident molestias aut minus excepturi officiis earum perferendis, numquam similique labore totam.</p>
 : <Form />}
        </section>
    )
}